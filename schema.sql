...
create table students (id bigint not null, birth_date date, first_name varchar(100) not null, last_name varchar(100) not null, registration_ts timestamp not null, version integer, primary key (id))
create table teachers (id bigint not null, first_name varchar(100) not null, gender varchar(255), last_name varchar(100) not null, area_code integer not null, country_code varchar(255) not null, serial_number varchar(255) not null, version integer, primary key (id))
create table teachers_courses (teacher_id bigint not null, courses_id bigint not null)
alter table courses_students add constraint UK_mfgvbrwprung9pjq6c4lb2re8 unique (students_id)
...
create table courses (id bigint not null, description varchar(255), end_date date, name varchar(255), number varchar(255), start_date date, teacher_id bigint, primary key (id))
create table courses_students (course_id bigint not null, students_id bigint not null)
create table students (id bigint not null, first_name varchar(100) not null, last_name varchar(100) not null, registration_ts timestamp not null, version integer, primary key (id))
create table teachers (id bigint not null, first_name varchar(100) not null, gender varchar(255), last_name varchar(100) not null, area_code integer not null, country_code varchar(255) not null, serial_number varchar(255) not null, version integer, primary key (id))
create table teachers_courses (teacher_id bigint not null, courses_id bigint not null)
alter table courses_students add constraint UK_mfgvbrwprung9pjq6c4lb2re8 unique (students_id)
alter table teachers_courses add constraint UK_63y8pfkasap618r4tkjefsjov unique (courses_id)
